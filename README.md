...
🏗️ Project Structure
frontend/ ├── src/ │ ├── components/ │ │ ├── Bot.jsx # Main chat UI │ │ ├── MessageInput.jsx# Input + send functionality │ │ └── ...other files │ ├── store/ │ │ └── useChatStore.js # Handles message state │ ├── hooks/ │ │ └── useKeyboardSound.js # Optional sound effect │ ├── index.css # Global + custom CSS animations │ ├── App.jsx # Entry point for LUNA UI │ └── main.jsx # React root └── package.json

🪄 Cool UI Animations
👋 Welcome Animation
LUNA greets you with a looping text: Hi, I'm LUNA 👩‍🚀 Hi, I'm AI 🤖 Animated with smooth transitions using CSS or Framer Motion.
